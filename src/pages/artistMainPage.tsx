  ...
  return (
    <div className="flex flex-col justify-center bg-black text-white min-h-screen">
      <div className="flex flex-col items-center mb-4">
        <h1 className="text-4xl font-bold mb-4">Find Your Favorite Artists</h1>
        <p className="text-gray-400 text-center max-w-md">
          Search by artist name or tag. Use <span className="text-blue-400">#tag</span> to filter by tag.
        </p>
      </div>
